...
def read_iniHead(inputFile,outputFile):
    ...
    options = config.options('spec2006-1core-CFP')
...
if __name__=='__main__':
  ...
  try:
      ...
      iniFileName='spec2006-1core_CFP_1.ini'
      csvFileName='spec2006-1core_CFP.csv'

      result_code = read_iniHead(iniFileName,csvFileName)

      iniFilePre = 'spec2006-1core_CFP_'
      iniFileEnd = '.ini'
