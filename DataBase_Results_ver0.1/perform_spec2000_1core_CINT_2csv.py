...
def read_iniHead(inputFile,outputFile):
    ...
    options = config.options('spec2000-1core-CINT')
...
if __name__=='__main__':
  ...
  try:
      ...
      iniFileName='spec2000-1core_CINT_1.ini'
      csvFileName='spec2000-1core_CINT.csv'

      result_code = read_iniHead(iniFileName,csvFileName)

      iniFilePre = 'spec2000-1core_CINT_'
      iniFileEnd = '.ini'
