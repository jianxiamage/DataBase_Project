...
cursor.execute('truncate table score_spec2006_ncore_CINT;')
sql_insert = '''
insert into score_spec2006_ncore_CINT(`400.perlbench`,`401.bzip2`,`403.gcc`,`429.mcf`,`445.gobmk`,`456.hmmer`,`458.sjeng`,`462.libquantum`,`464.h264ref`,`471.omnetpp`,`473.astar`,`483.xalancbmk`,SPECint_rate_base2006)
values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);
'''

i=1
with io.open('spec2006-ncore_CINT.csv', mode= 'rt', encoding='utf-8') as file_handler:
    # 通过迭代器，遍历csv文件中的所有样本
