...
def read_iniHead(inputFile,outputFile):
    ...
    options = config.options('spec2000-ncore-CFP')
...
if __name__=='__main__':
  ...
  try:
      ...
      iniFileName='spec2000-ncore_CFP_1.ini'
      csvFileName='spec2000-ncore_CFP.csv'

      result_code = read_iniHead(iniFileName,csvFileName)

      iniFilePre = 'spec2000-ncore_CFP_'
      iniFileEnd = '.ini'
