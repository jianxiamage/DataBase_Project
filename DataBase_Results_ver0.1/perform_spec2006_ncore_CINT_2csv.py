...
def read_iniHead(inputFile,outputFile):
    ...
    options = config.options('spec2006-ncore-CINT')
...
if __name__=='__main__':
  ...
  try:
      ...
      iniFileName='spec2006-ncore_CINT_1.ini'
      csvFileName='spec2006-ncore_CINT.csv'

      result_code = read_iniHead(iniFileName,csvFileName)

      iniFilePre = 'spec2006-ncore_CINT_'
      iniFileEnd = '.ini'
