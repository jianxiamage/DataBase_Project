...
cursor.execute('truncate table score_stream_1core;')
sql_insert = '''
insert into score_stream_1core(Copy,Scale,`Add`,Triad) values(%s, %s, %s, %s);
'''

i=1
with io.open('stream_1core.csv', mode= 'rt', encoding='utf-8') as file_handler:
    # 通过迭代器，遍历csv文件中的所有样本
