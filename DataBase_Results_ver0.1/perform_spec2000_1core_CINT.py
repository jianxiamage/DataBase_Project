...
cursor.execute('truncate table score_spec2000_1core_CINT;')
sql_insert = '''
insert into score_spec2000_1core_CINT(`164.gzip`,`175.vpr`,`176.gcc`,`181.mcf`,`186.crafty`,`197.parser`,`252.eon`,`253.perlbmk`,`254.gap`,`255.vortex`,`256.bzip2`,`300.twolf`,SPECint_base2000) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);
'''

i=1
with io.open('spec2000-1core_CINT.csv', mode= 'rt', encoding='utf-8') as file_handler:
    # 通过迭代器，遍历csv文件中的所有样本
