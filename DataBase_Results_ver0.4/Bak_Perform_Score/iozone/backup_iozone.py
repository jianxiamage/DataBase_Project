...
if __name__ == '__main__':
    ...
    try:
        ...
        as
        select Tag,node_num,`read`,`Re-reader`,`Random-Read`,`write`,`Re-writer`,`Random-Write` from %s;
        ...
        #------------------------------------------------------------------------------
        sql_insert = '''
        insert into `%s`(Tag,node_num,`read`,`Re-reader`,`Random-Read`,`write`,`Re-writer`,`Random-Write`)
        select * from %s
