...
if __name__ == '__main__':
    ...
    try:
        ...
        as
        select Tag,node_num,`400.perlbench`,`401.bzip2`,`403.gcc`,`429.mcf`,`445.gobmk`,`456.hmmer`,`458.sjeng`,`462.libquantum`,`464.h264ref`,`471.omnetpp`,`473.astar`,`483.xalancbmk`,SPECint_base2006 from %s;
        ...
        #------------------------------------------------------------------------------
        sql_insert = '''
        insert into `%s`(Tag,node_num,`400.perlbench`,`401.bzip2`,`403.gcc`,`429.mcf`,`445.gobmk`,`456.hmmer`,`458.sjeng`,`462.libquantum`,`464.h264ref`,`471.omnetpp`,`473.astar`,`483.xalancbmk`,SPECint_base2006)
        select * from %s
