...
if __name__ == '__main__':
    ...
    try:
        ...
        as
        select Tag,node_num,`168.wupwise`,`171.swim`,`172.mgrid`,`173.applu`,`177.mesa`,`178.galgel`,`179.art`,`183.equake`,`187.facerec`,`188.ammp`,`189.lucas`,`191.fma3d`,`200.sixtrack`,`301.apsi`,SPECfp_rate_base2000 from %s;
        ...
        #------------------------------------------------------------------------------
        sql_insert = '''
        insert into `%s`(Tag,node_num,`168.wupwise`,`171.swim`,`172.mgrid`,`173.applu`,`177.mesa`,`178.galgel`,`179.art`,`183.equake`,`187.facerec`,`188.ammp`,`189.lucas`,`191.fma3d`,`200.sixtrack`,`301.apsi`,SPECfp_rate_base2000)
        select * from %s
