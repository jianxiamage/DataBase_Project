...
#读取csv文件插入表数据
sql_insert = '''
insert into score_UnixBench_8thread(Tag,node_num,test_option,ref_data,score) values(%s, %s, %s, %s, %s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_UnixBench_8thread'
#------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_UnixBench_8thread'
        sql_delete = "delete from score_UnixBench_8thread where Tag ='%s'" %(test_Tag)
