...
#读取csv文件插入表数据
sql_insert = '''
insert into score_spec2000_ncore_CINT(Tag,node_num,`164.gzip`,`175.vpr`,`176.gcc`,`181.mcf`,`186.crafty`,`197.parser`,`252.eon`,`253.perlbmk`,`254.gap`,`255.vortex`,`256.bzip2`,`300.twolf`,SPECint_rate_base2000) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_spec2000_ncore_CINT'
#------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_spec2000_ncore_CINT'
        sql_delete = "delete from score_spec2000_ncore_CINT where Tag ='%s'" %(test_Tag)
