...
#创建表结构
sql_create = '''
create table if not exists score_spec2000_ncore_CFP(
  ...
  SPECfp_rate_base2000 varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (id)
...
#读取csv文件插入表数据
sql_insert = '''
insert into score_spec2000_ncore_CFP(Tag,node_num,`168.wupwise`,`171.swim`,`172.mgrid`,`173.applu`,`177.mesa`,`178.galgel`,`179.art`,`183.equake`,`187.facerec`,`188.ammp`,`189.lucas`,`191.fma3d`,`200.sixtrack`,`301.apsi`,SPECfp_rate_base2000) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s,%s,%s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_spec2000_ncore_CFP'
#------------------------------------------------------------------------------
        ...
        try:
            ...
            with io.open(input_file, mode= 'rt', encoding='utf-8') as file_handler:
                ...
                for line in islice(lines, 1, None):
                   ...
                   #print(res)
                   if res != ['']:
                     self.cur.execute(sql,[res[0],res[1],res[2],res[3],res[4],res[5],res[6],res[7],res[8],res[9],res[10],res[11],res[12],res[13],res[14],res[15],res[16]])
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_spec2000_ncore_CFP'
        sql_delete = "delete from score_spec2000_ncore_CFP where Tag ='%s'" %(test_Tag)
