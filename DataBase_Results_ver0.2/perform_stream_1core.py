...
#创建表结构
sql_create = '''
create table if not exists score_stream_1core(
...
#读取csv文件插入表数据
sql_insert = '''
insert into score_stream_1core(Tag,node_num,Copy,Scale,`Add`,Triad) values(%s, %s, %s, %s, %s, %s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_stream_1core'
#------------------------------------------------------------------------------
        ...
        try:
            ...
            with io.open(input_file, mode= 'rt', encoding='utf-8') as file_handler:
                ...
                for line in islice(lines, 1, None):
                   ...
                   #print(res)
                   if res != ['']:
                     self.cur.execute(sql,[res[0], res[1], res[2],res[3], res[4], res[5]])
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_stream_1core'
        sql_delete = "delete from score_stream_1core where Tag ='%s'" %(test_Tag)
