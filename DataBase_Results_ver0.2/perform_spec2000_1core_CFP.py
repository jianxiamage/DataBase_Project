...
#读取csv文件插入表数据
sql_insert = '''
insert into score_spec2000_1core_CFP(Tag,node_num,`168.wupwise`,`171.swim`,`172.mgrid`,`173.applu`,`177.mesa`,`178.galgel`,`179.art`,`183.equake`,`187.facerec`,`188.ammp`,`189.lucas`,`191.fma3d`,`200.sixtrack`,`301.apsi`,SPECfp_base2000) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s,%s,%s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_spec2000_1core_CFP'
#------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_spec2000_1core_CFP'
        sql_delete = "delete from score_spec2000_1core_CFP where Tag ='%s'" %(test_Tag)
