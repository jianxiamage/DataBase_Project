...
#读取csv文件插入表数据
sql_insert = '''
insert into score_spec2006_ncore_CFP(Tag,node_num,`410.bwaves`,`416.gamess`,`433.milc`,`434.zeusmp`,`435.gromacs`,`436.cactusADM`,`437.leslie3d`,`444.namd`,`447.dealII`,`450.soplex`,`453.povray`,`454.calculix`,`459.GemsFDTD`,`465.tonto`,`470.lbm`,`481.wrf`,`482.sphinx3`,SPECfp_rate_base2006) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_spec2006_ncore_CFP'
#------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_spec2006_ncore_CFP'
        sql_delete = "delete from score_spec2006_ncore_CFP where Tag ='%s'" %(test_Tag)
