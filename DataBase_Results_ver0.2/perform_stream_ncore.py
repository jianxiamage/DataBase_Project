...
#读取csv文件插入表数据
sql_insert = '''
insert into score_stream_ncore(Tag,node_num,Copy,Scale,`Add`,Triad) values(%s, %s, %s, %s, %s, %s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_stream_ncore'
#------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_stream_ncore'
        sql_delete = "delete from score_stream_ncore where Tag ='%s'" %(test_Tag)
