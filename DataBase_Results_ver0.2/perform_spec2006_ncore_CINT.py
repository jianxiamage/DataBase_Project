...
#创建表结构
sql_create = '''
create table if not exists score_spec2006_ncore_CINT(
  ...
  SPECint_rate_base2006 varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (id)
...
#读取csv文件插入表数据
sql_insert = '''
insert into score_spec2006_ncore_CINT(Tag,node_num,`400.perlbench`,`401.bzip2`,`403.gcc`,`429.mcf`,`445.gobmk`,`456.hmmer`,`458.sjeng`,`462.libquantum`,`464.h264ref`,`471.omnetpp`,`473.astar`,`483.xalancbmk`,SPECint_rate_base2006) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);
'''
#------------------------------------------------------------------------------
trunc_sql = 'truncate table score_spec2006_ncore_CINT'
#------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    try:
        ...
        #trunc_sql = 'truncate table score_spec2006_ncore_CINT'
        sql_delete = "delete from score_spec2006_ncore_CINT where Tag ='%s'" %(test_Tag)
